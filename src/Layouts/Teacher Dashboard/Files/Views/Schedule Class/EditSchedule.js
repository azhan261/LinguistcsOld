...
import { updateClassSchedules } from '../../Apis/apiForClassSchedule';
...
function EditSchedule() {
  ...
  const log = (data) => {
      if (editorRef.current) {
        ...
        updateClassSchedules(data, location.state._id)
  ...
  const onSubmit = async (data) => {
    ...
    const formik = useFormik({
        initialValues: {
           ...
           startTime:'',
           endTime: '',
           scheduleTitle:location.state.scheduleTitle,
           scheduleTime:location.state.scheduleTime,
           scheduleContent:location.state.scheduleContent,
