...
$(function () {
    ...
    $("#addCatForm").validate({
        ...
        submitHandler: function (form) {
            ...
            $.ajax({
                url: APP_URL + "/admin/save-course-alloc",
                data: form_data,
                type: "post",
                cache: false,
                contentType: false,
...
function UpdateCat(event){
     ...
     if(id){
         $.ajax({
                url:APP_URL + "/admin/get-course-alloc",
                ...
                success:function(response){
                    ...
                    if(response.courses){
                      ...
                      $("#course_id").val(response.courses.course_id).change();
                      $("#batch_id").val(response.courses.batch_id).change();
                      $("#teacher_id").val(response.courses.class_teacher).change();
...
function TrashCat(event){
    ...
    if(id){
        ...
        if(res){
            $.ajax({
                url:APP_URL + "/admin/trash-course-alloc",
                data:{'id':id,'_token':csrfTokenVal},
                dataType:'json',
                type:'post',
                beforeSend: function () {
