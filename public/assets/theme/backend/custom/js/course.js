...
$(function () {
    ...
    $("#addCatForm").validate({
        ...
        submitHandler: function (form) {
            ...
            form_data.append('mini_attend', $('#mini_attend').val());
            form_data.append('attendance_type', $('#attendance_type').val());
            form_data.append('total_working_day', $('#total_working_day').val());
            form_data.append('status', $('#status').val());
            form_data.append('id', $('#cid').val());
            form_data.append('_token', csrfTokenVal);
         
            $.ajax({
                url: APP_URL + "/admin/save-course",
                data: form_data,
                type: "post",
                cache: false,
                contentType: false,
         ...
         $.ajax({
                ...
                success:function(response){
                    ...
                    if(response.courses){
                      ...
                      $("#course_name").val(response.courses.course_name);
                      $("#description").val(response.courses.description).change();
                      $("#mini_attend").val(response.courses.mini_attend).change();
                      $("#attendance_type").val(response.courses.attendance_type).change();
                      $("#total_working_day").val(response.courses.total_working_day).change();
                      $("#code").val(response.courses.code).change();
...
function TrashCat(event){
    ...
    if(id){
        ...
        if(res){
            $.ajax({
                url:APP_URL + "/admin/trash-course",
                data:{'id':id,'_token':csrfTokenVal},
                dataType:'json',
                type:'post',
                beforeSend: function () {
