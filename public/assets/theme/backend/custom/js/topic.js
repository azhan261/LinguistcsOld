         ...
         $.ajax({
                ...
                success:function(response){
                    ...
                    if(response.topics){
                      ...
                      $("#cid").val(response.topics.id);
                      $("#topic_name").val(response.topics.name);
                      $("#course_id").val(response.topics.course_id).change();
                      $("#level_no").val(response.topics.level_no).change();
                      $("#activity_id").val(response.topics.activity_id).change();
                      $("#status").val(response.topics.status).change();
                      $("#addCatModal").modal('show');
                  }
