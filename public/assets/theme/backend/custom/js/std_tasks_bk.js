    ...
    $("#addCatForm").validate({
        ...
        submitHandler: function (form) {
            ...
            var form_data = new FormData();
             ...
             if($('.question_list_').length)
            {
             $.each($('.question_list_'), function(k)
            {
              
              form_data.append("question_id_[]",  $(this).val());
            
             });
 
            }
            
            if($('.answer_list_').length)
            {
             $.each($('.answer_list_'), function(k)
            {
              var option_list_ = $(this).val();
              if($(this).is(':checked')){
              form_data.append("answer_list_[]",  option_list_);
             }
            ...
            if($('.std-answer-d').length)
            {
             $.each($('.std-answer-d'), function(k)
            {
              var option_list_ = $(this).val();
            ...
            if($('.question_id-d').length)
            {
             $.each($('.question_id-d'), function(k)
            {
            ...
            if($('.writing_content').length)
            {
             form_data.append("writing_content_", $('.writing_content').val());
            ...
            {
             form_data.append("activity_id", $('.activity_id').val());
